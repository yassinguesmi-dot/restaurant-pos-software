[app]
# Configuration pour TABLETTE (Landscape)
title = Cafe216 POS Tablet

# (str) Package name
package.name = cafe216postablet
...
# TABLETTE: Landscape, 1280x800 optimisé
...
# arm64-v8a pour tablettes modernes (64-bit)
